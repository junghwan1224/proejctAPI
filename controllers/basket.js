...
exports.readByUser = async (req, res) => {
  try {
    ...
    for (const raw_item of raw_items) {
      ...
      item["image"] = raw_item.product.product.image;
      item["maker"] = raw_item.product.product.maker;
      item["maker_number"] = raw_item.product.product.maker_number;
      item["type"] = raw_item.product.product.type;
